<?php
    class Core {
        ...
        public function setController($currentController = 'MasterController', $currentMethod = 'signIn', $params = []) {
            $url = $this->getUrl();
        ...
        // Función para generar la url correspondiente a la vista seleccionada
