...
<head>
    ...
    <meta charset="UTF-8">
    <meta name="description" content="Sign In - Screen">
...
<body>
    ...
    <section class="p-5 m-5">
        ...
        <form action="<?php echo $data['signInAction']?>" method="POST" class="container border border-info p-3 rounded needs-validation" style="width: 500px" novalidate>
